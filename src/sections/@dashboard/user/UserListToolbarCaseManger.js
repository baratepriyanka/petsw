...
UserListToolbarCaseManger.propTypes = {
  numSelected: PropTypes.number,
  filterName: PropTypes.string,
  onFilterName: PropTypes.func,
};

export default function UserListToolbarCaseManger({ numSelected, filterName, onFilterName }) {
  const [values, setValues] = React.useState(['100', '200', '300', '400']);
...
{/*         
    ...
    */}
            ...
            {/* <Box className="boxbutton">
              ...
              <Button size="small" type="button" variant="contained" sx={{ ml:2, backgroundColor: '#9aa1b0' ,mt:2}}>
                Print
              </Button>
            </Box> */}
            <SearchStyle

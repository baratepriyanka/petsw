...
const TABLE_HEAD = [
  ...
  { id: 'dateOfAdmission', label: 'Admission Date ', alignRight: false },
...
export default function Consent() {
  ...
  const getConsentData = async () => {
    ...
    const response = await fetch(
      `http://${process.env.REACT_APP_API_HOST}:${process.env.REACT_APP_API_PORT}/web/get-all-consent/${loginId}`
    );
    ...
    if (response) {
      ...
      setConsentData(reportPatientData);
      setMedicinePageData([reportPatientData]);
      //  console.log(opdData)
    }
    // setConsentData(await response.json());
    // console.log(consentData);
  };
  const searchItems = (searchValue) => {
    setSearchInput(searchValue);
    if (searchInput !== '') {
      const filteredData = consentData.filter(({ curElem, name }) => {
        // console.log(curElem);
      ...
      // console.log("curElem");
      setFilteredResults(consentData);
    }
  };
  ...
  const deleteConsentRow = async (e) => {
    e.preventDefault();
    const aa = e.target.value;
    // console.log(aa);
    Axios.post(`http://${process.env.REACT_APP_API_HOST}:${process.env.REACT_APP_API_PORT}/web/delete-consent/${aa}`) // <-- remove ;
      .then((res) => {
                                  ...
                                  .map(({ curElem, name }) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        <TableCell align="left">{curElem.ownerName}</TableCell>
                                        {/* <TableCell align="left">{curElem.dateOfAdmission}</TableCell>                       */}
                                          ...
                                          <TableCell style={{ width: 'maxWidth' }}>
                                            <Box style={{ display: 'flex' }}>
                                              {/* <Button
                                                ...
                                                variant="contained"
                                                component={RouterLink}
                                                to={`/dashboard/EditConsentList/${curElem.id}`}
                                              ...
                                              <Button
                                                ...
                                                id="abcd"
                                                component={RouterLink}
                                                to={`/dashboard/InfoConsentList/${curElem.id}`}

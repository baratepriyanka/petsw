...
// import { BedAllotmentForm } from '../sections/auth/BedAllotmentSection';
    ...
    {isLoggedin ? (
      <Page title="AddAllotment">
        <Container>
          ...
          <Button variant="contained" component={RouterLink} to="/dashboard/AddAllotment" startIcon={<Iconify icon="eva:plus-fill" />} sx={{backgroundColor: '#08670f'}}>
         Add New Allotment
          </Button>

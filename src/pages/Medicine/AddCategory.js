...
import { UserListHead, UserListToolbar, UserMoreMenu ,UserListToolbarMedicineList} from '../../sections/@dashboard/user';
// mock
    ...
    <Page title="AddCategory">
        <Container>
          <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
            ...
            <Button variant="contained" component={RouterLink} to="/dashboard/AddCategory" startIcon={<Iconify icon="eva:plus-fill" />} sx={{backgroundColor: '#08670f'}}>
            Add Medicine
            </Button>

...
const TABLE_HEAD = [
  { id: 'id', label: 'Medicine id', alignRight: false },
...
export default function MedicineList() {
  ...
  const searchItems = (searchValue) => {
    ...
    if (searchInput !== '') {
      ...
      // setMedicinePageData(filteredData);
      // console.log(medicinePageData);
    } else {
      setFilteredResults(medicineData);
      // setMedicinePageData(medicineData);
      // console.log(medicinePageData);
    }
  };
  ...
  // const emptyRows = page > 0 ? Math.max(0, (1 + page) * rowsPerPage - medicineData.length) : 0;

  const filteredUsers = applySortFilter(medicineData, getComparator(order, orderBy), filterName);
                                  ...
                                  .map(({ curElem, name }) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        <TableCell align="center">{curElem.mastercategory.name}</TableCell>
                                        ...
                                        <TableCell align="center">{curElem.quantity}</TableCell>
                                        <TableCell align="center">{curElem.company}</TableCell>
                                        <TableCell align="center">{curElem.effects}</TableCell>
                                        {/* <TableCell align="center">{formatDate}</TableCell> */}
                                        <TableCell id="hh2"align="center" style={{fontSize:'13px',fontWeight:'400',overflowX:'hidden',Wrap:'nowrap'}}>
                                            <div>
                                            {formatDate}
                                              </div> </TableCell>
                                            ...
                                            >
                                              <Box sx={style}>
                                                ...
                                                <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                                                  Are you sure you want to Delete Medicine Stock?
                                                </Typography>
                                                </div>
                                                <div className='text-center'>
                                                <Button

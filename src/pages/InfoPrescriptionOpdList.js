...
import { InfoPrescriptionOpdForm } from '../sections/auth/InfoPrescriptionOpd';
...
export default function InfoPrescriptionOpdList() {
...
const [hospitalid, setHospitalId] = useState();
  ...
  return (
    <>
    {isLoggedin ? (
      <Page title="InfoPrescriptionList">
        <Container>

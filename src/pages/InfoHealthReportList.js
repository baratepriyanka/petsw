...
import { InfoHealthReportForm } from '../sections/auth/InfoHealthReport';
...
export default function InfoHealthReportList() {
  ...
  return (
     <>
    {isLoggedin ? (
      <Page title="InfoHealthReportList">
        <Container>
